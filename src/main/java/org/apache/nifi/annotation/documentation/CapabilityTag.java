 ...
 * associate a key-value pair with the component. These tags do not affect the
 * component in any way but serve as additional documentation and can be
 * included in the extension manifest and generated documentation.
 */
@Documented
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Inherited
@Repeatable(CapabilityTags.class)
public @interface CapabilityTag {

    /**
     * @return the key of the capability tag
     */
    String key();

    /**
     * @return the value of the capability tag
     */
    String value();
}
